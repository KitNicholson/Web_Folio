var sketch = function(p) {
  ...
  p.randomness = 250; // how far the features can move
  ...
  p.draw = function() {
    ...
    // draw head shot
    p.drawFeature(p.headshot, 0, 0, 0, 1.4, false);

    // add extra eyes
    p.drawFeature(p.eye1, 240, 50, 1, 1.01, true);
    p.drawFeature(p.eye2, -270, -20, 2, 1.01, true);
    p.drawFeature(p.eye3, 100, -230, 3, 1.01, true);
  ...
  p.drawFeature = function(feature, distX, distY, num, scale, animate) {
